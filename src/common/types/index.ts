 ...
 */
export type PolymorphicPropsWithoutRef<P, C extends React.ElementType> = MergeProps<
 ...
 */
export type PolymorphicPropsWithRef<P, C extends React.ElementType> = MergeProps<
  C extends keyof JSX.IntrinsicElements
...
export type PolymorphicExoticComponent<P, C extends React.ElementType> = MergeProps<
